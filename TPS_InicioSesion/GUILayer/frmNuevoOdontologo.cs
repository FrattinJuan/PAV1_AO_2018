                ...
                case Opcion.insert:
                    ...
                    case Opcion.update:
                    {
                        if (validar_campos())
                        {
                            ...
                            {
                                MessageBox.Show("Usuario actualizado! Perrooo!!", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information);
                                this.Dispose();
                            }
                            else
                                MessageBox.Show("Error al actualizar el usuario! gil", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                    ...
                    case Opcion.delete:
                    {
                        if (MessageBox.Show("Seguro que desea habilitar/deshabilitar el usuario seleccionado?", "Aviso", MessageBoxButtons.OKCancel, MessageBoxIcon.Question) == DialogResult.OK)
                        {
                            ...
                            if (oUsuarioService.modificarEstadoUsuario(oUsuarioSelected))
                            {
                                ...
                                MessageBox.Show("Error al actualizar el usuario! bobo", "Información", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
