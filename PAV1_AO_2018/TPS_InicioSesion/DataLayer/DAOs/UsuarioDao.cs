...
namespace PAV1_AO_2018.DataLayer.DAOs
{
    public class UsuarioDao
    {
        ...
        public IList<Usuario> getAll()
        {
            ...
            string sql = "Select x.*, y.n_perfil, y.id_perfil as perfil_usuario, z.n_tipo, z.cod_tipo as tipoDoc_usuario from Usuarios x, Perfiles y, TiposDocumento z where x.id_perfil=y.id_perfil AND x.tipoDocumento = z.cod_tipo AND x.estado = 'S'";
            Usuario oUsuario = null/* TODO Change to default(_) if this is not a reference type */;
